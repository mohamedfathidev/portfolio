                        ...
                        <div class="text-uppercase">
                            ...
                            @php
                                foreach ($categoriesArray as $category) {
                                    echo $category . ' &middot';
                                }
                            @endphp
                        </div>
                    </div>
                    <h1 class="display-3 fw-bolder mb-5"><span class="text-gradient d-inline">{{ $details->slogan }}</span>
                    </h1>
            ...
            <div class="col-xxl-7">
                ...
                <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                    <div class="profile bg-gradient-primary-to-secondary">
                        ...
                        <img class="profile-img" src="{{ asset($details->image) }}" alt="..."
            ...
            <div class="row gx-5 justify-content-center">
                <div class="col-xxl-8">
                    <div class="text-center my-5">
                        ...
                        <p class="lead fw-light mb-4">{{$about->title}}</p>
                        <p class="text-muted">{{$about->about_me}}</p>
                        <div class="d-flex justify-content-center fs-2 gap-4">
                            <a class="text-gradient" target="_blank" href="https://wa.me/{{ $about->whatsapp }}">
                                <i class="bi bi-whatsapp"></i> 
                            </a>
                            <a class="text-gradient" target="_blank" href="{{$about->linkedin}}"><i class="bi bi-linkedin"></i></a>
                            <a class="text-gradient" target="_blank" href="{{$about->github}}"><i class="bi bi-github"></i></a>
                        </div>
                    </div>
                </div>
            </div>
